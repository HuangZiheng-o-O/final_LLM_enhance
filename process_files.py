...
keywords = [
    ...
    "Bollywood", "Cossack", "Hora", "Swing", "Two-Step", "Line Dancing", "Square", "Zouk",
    ...
    "Bass Guitar", "Violin", "Viola", "Cello", "Double Bass", "Harp", "Mandolin", "Banjo", "Ukulele", "Sitar",
    "Zither", "Lute", "Dobro", "Resonator Guitar", "Balalaika", "Erhu", "Flute", "Piccolo", "Clarinet",
    ...
    "Synthesizer", "Guitar", "Bass", "Theremin", "Drum Machine", "Sampler", "Electronic Drum Kit","Archery", "Equestrian", "Horseback Riding", "Gymnastics", "Parkour", "Trampoline",
    ...
    "Trapeze", "Aerial Silks", "Aerial Hoop (Lyra)", "Aerial Straps", "Pole Dancing", "Contortion",
