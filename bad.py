...
def interpolate_and_resample_velocity(original_points):
    ...
    uniform_points = [(splev(ui, tck)[0], splev(ui, tck)[1]) for ui in uniform_u]
    # example uniform_points = [(0, 0), (1, 2), (2, 0), (3, 3)]

    # Calculate tangent vectors
    tangents = []
    for i in range(len(uniform_points) - 1):
        x_tangent = uniform_points[i + 1][0] - uniform_points[i][0]
        y_tangent = uniform_points[i + 1][1] - uniform_points[i][1]
        tangents.append((x_tangent, y_tangent))
...
#
# # Example usage
# original_points = [(0, 0), (1, 2), (2, 0), (3, 3)]
# uniform_points, tangents = interpolate_and_resample(original_points)
#
# # Output the results
...
def inside(
    ...
    try:
        tangent_vectors = interpolate_and_resample_velocity(original_points)
